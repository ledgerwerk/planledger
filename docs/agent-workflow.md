...
Planledger snapshots the exact UTF-8 content into the `request` component. The
source file can be deleted or changed after creation without changing the plan.
